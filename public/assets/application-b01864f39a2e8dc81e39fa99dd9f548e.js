...
jQuery(function() {
 ...
 $('#question_description').on('keyup focusout focusin input', function(){
	judge.validate(document.getElementById('question_description'), {
  		valid: function(element) {
  			 $('#question_description').css({	 	
 ...
 $('#question_strength').on('keyup focusout focusin input', function(){
	judge.validate(document.getElementById('question_strength'), {
  		valid: function(element) {
  			 $('#question_strength').css({	 	
  			 'border' : '1px solid rgba(82,168,236,0.8)',
 			 'outline' : 'thin dotted \9',
  			 '-moz-box-shadow' : 'inset 0 1px 1px rgba(0,0,0,0.075), 0 0 8px rgba(82,168,236,0.6)',
  			 '-webkit-box-shadow' : 'inset 0 1px 1px rgba(0,0,0,0.075), 0 0 8px rgba(82,168,236,0.6)',
